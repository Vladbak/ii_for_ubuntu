# 
#  GenerateInstallersUTII.cmake
#  cmake/macros
#
#  GenerateInstallers.cmake Created by Leonardo Murillo on 12/16/2015.
#  Modified for UTII by Thijs Wenker 12/29/2015
...
macro(GENERATE_INSTALLERS_UTII)
  if (DEFINED DEPLOY_PACKAGE AND DEPLOY_PACKAGE AND WIN32)
    file(MAKE_DIRECTORY "${CMAKE_BINARY_DIR}/utii-client-deployment")
    ...
    add_custom_target(
      build-package ALL
      DEPENDS interface
      COMMAND set INSTALLER_SOURCE_DIR=${CMAKE_BINARY_DIR}/utii-client-deployment
      ...
      COMMAND CMD /C "\"${MAKENSIS_COMMAND}\" ${CMAKE_SOURCE_DIR}/tools/nsis/release-utii.nsi"
    )
  endif ()
endmacro()
